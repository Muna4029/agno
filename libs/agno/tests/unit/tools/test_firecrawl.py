...
@pytest.fixture
def mock_firecrawl():
    """Create a mock Firecrawl instance."""
    with patch("agno.tools.firecrawl.Firecrawl") as mock_firecrawl_cls:
        mock_app = Mock(spec=Firecrawl)
...
def test_init_with_env_vars():
    ...
    with patch("agno.tools.firecrawl.Firecrawl"):
