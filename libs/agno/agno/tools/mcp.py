...
class MCPTools(Toolkit):
    ...
    async def __aenter__(self) -> "MCPTools":
        ...
        if self._session_context is None:
            raise RuntimeError("Failed to create MCP session context")
    ...
    async def __aexit__(self, exc_type: Optional[Union[type[BaseException], None]], exc_val: Optional[Union[BaseException, None]], exc_tb: Optional[Union[TracebackType, None]]) -> None:
