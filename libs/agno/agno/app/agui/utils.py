...
def _create_events_from_chunk(
    chunk: RunResponse | TeamRunResponse, message_id: str, message_started: bool, event_buffer: EventBuffer
...
def stream_agno_response_as_agui_events(
    response_stream: Iterator[RunResponse] | Iterator[TeamRunResponse], thread_id: str, run_id: str
) -> Iterator[BaseEvent]:
...
async def async_stream_agno_response_as_agui_events(
    response_stream: AsyncIterator[RunResponse] | AsyncIterator[TeamRunResponse], thread_id: str, run_id: str
