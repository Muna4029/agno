...
class Citations(BaseModel):
    ...
    urls: list[UrlCitation] | None = None

    # Document Citations
    documents: list[DocumentCitation] | None = None
...
class Message(BaseModel):
    ...
    audio_output: AudioResponse | None = None
    image_output: ImageArtifact | None = None
    ...
    def log(self, metrics: bool = True, level: str | None = None):
