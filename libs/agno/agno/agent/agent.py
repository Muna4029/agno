...
class Agent:
    ...
    search_previous_sessions_history: bool | None = False
    num_history_sessions: int | None = None
    ...
    # --- Agent Memory ---
    memory: AgentMemory | Memory | None = None
    ...
    num_history_responses: int | None = None
    ...
    add_messages: list[dict | Message] | None = None
    ...
    user_message: list | dict | str | Callable | Message | None = None
    ...
    def __init__(
        ...
        *,
        ...
        knowledge: AgentKnowledge | None = None,
        knowledge_filters: dict[str, Any] | None = None,
        enable_agentic_knowledge_filters: bool | None = None,
        add_references: bool = False,
        retriever: Callable[..., list[dict] | None] | None = None,
        references_format: Literal["json", "yaml"] = "json",
        storage: Storage | None = None,
        ...
        self.run_input: str | list | dict | Message | None = None
        self.run_messages: RunMessages | None = None
        self.run_response: RunResponse | None = None
    ...
    def is_paused(self) -> bool:
        return bool(self.run_response is not None and self.run_response.is_paused)
    ...
    def _run(
        ...
        messages: Sequence[dict | Message] | None = None,
    ) -> RunResponse:
        ...
        if self.parser_model is not None:
            if self.response_model is not None:
                ...
                parser_model_response_message: Message | None = None
    ...
    def _run_tool(
        self, run_messages: RunMessages, tool: ToolExecution, session_id: str | None = None
    ) -> Iterator[RunResponse]:
        self.model = cast(Model, self.model)
        # Execute the tool
    ...
    def get_tools(
        ...
        user_id: str | None = None,
        knowledge_filters: dict[str, Any] | None = None,
    ) -> list[Toolkit | Callable | Function | dict] | None:
        agent_tools: list[Toolkit | Callable | Function | dict] = []
    ...
    def _get_response_format(self, model: Model | None = None) -> dict | type[BaseModel] | None:
    ...
    def get_agent_session(self, session_id: str, user_id: str | None = None) -> AgentSession:
    ...
    def load_agent_session(self, session: AgentSession):
        ...
        if not (isinstance(self.memory, (AgentMemory, Memory))):
    ...
    def write_to_storage(self, session_id: str, user_id: str | None = None) -> AgentSession | None:
    ...
    def add_introduction(self, introduction: str) -> None:
        ...
        if isinstance(self.memory, AgentMemory) and introduction is not None:
    ...
    def new_session(self) -> None:
        ...
        """
        self.agent_session = None
        if self.memory is not None and isinstance(self.memory, (AgentMemory, Memory)):
            self.memory.clear()
        self.session_id = str(uuid4())
    ...
    def get_system_message(self, session_id: str, user_id: str | None = None) -> Message | None:
    ...
    def get_run_messages(
        ...
        **kwargs: Any,
        ...
        if message is None or isinstance(message, (str, list)):
    ...
    def get_messages_for_parser_model(
        self, model_response: ModelResponse, response_format: dict | type[BaseModel] | None
    ) -> list[Message]:
    ...
    def deep_copy(self, *, update: dict[str, Any] | None = None) -> Agent:
    ...
    def get_transfer_function(self, member_agent: Agent, index: int, session_id: str | None = None) -> Function:
        ...
        strict = bool(member_agent.response_model is not None and member_agent.model is not None)
    ...
    def save_run_response_to_file(
        self, message: str | list | dict | Message | None = None, session_id: str | None = None
    ) -> None:
    ...
    def rename(self, name: str, session_id: str | None = None) -> None:
    ...
    def get_messages_for_session(self, session_id: str | None = None) -> list[Message]:
    ...
    def reason(self, run_messages: RunMessages, session_id: str | None = None) -> Iterator[RunResponse]:
    ...
    async def areason(self, run_messages: RunMessages, session_id: str | None = None) -> Any:
        # Yield a reasoning started event
        if self.stream_intermediate_steps:
            yield self.create_run_response(
    ...
    def get_chat_history_function(self, session_id: str) -> Callable:
        def get_chat_history(num_chats: int | None = None) -> str:
    ...
    def _log_agent_session(self, session_id: str, user_id: str | None = None):
    ...
    def _log_agent_run(self, session_id: str, user_id: str | None = None) -> None:
        self.set_monitoring()
    ...
    async def _alog_agent_run(self, session_id: str, user_id: str | None = None) -> None:
        self.set_monitoring()
        ...
        **kwargs: Any,
        ...
        if stream:
            ...
            with Live(console=console) as live_log:
                ...
                response_content_batch: str | JSON | Markdown = ""
    ...
    def _get_effective_filters(self, knowledge_filters: dict[str, Any] | None = None) -> dict[str, Any] | None:
        """
    ...
    def get_previous_sessions_messages_function(
        self, num_history_sessions: int | None = 2, user_id: str | None = None
    ) -> Callable:
