...
class Team:
    ...
    team_session_state: dict[str, Any] | None = None
    ...
    system_message: str | Callable | Message | None = None
    ...
    enable_agentic_knowledge_filters: bool | None = False
    ...
    #     ...
    retriever: Callable[..., list[dict | str] | None] | None = None
    ...
    # --- History ---
    # Memory for the team
    memory: TeamMemory | Memory | None = None
    ...
    num_of_interactions_from_history: int | None = None
    ...
    reasoning_model: Model | None = None
    ...
    def __init__(
        ...
        self.full_team_session_metrics: SessionMetrics | None = None

        self.run_id: str | None = None
        self.run_input: str | list | dict | None = None
        self.run_messages: RunMessages | None = None
        self.run_response: TeamRunResponse | None = None

        # Images generated during this session
        self.images: list[ImageArtifact] | None = None
        # Audio generated during this session
        self.audio: list[AudioArtifact] | None = None
        # Videos generated during this session
        self.videos: list[VideoArtifact] | None = None

        # Team session
        self.team_session: TeamSession | None = None

        self._tool_instructions: list[str] | None = None
        ...
        self._member_response_model: type[BaseModel] | None = None

        self._formatter: SafeFormatter | None = None
    ...
    def _initialize_member(self, member: Team | Agent, session_id: str | None = None) -> None:
    ...
    def initialize_team(self, session_id: str | None = None) -> None:
        self._set_defaults()
        ...
        if isinstance(self.memory, Memory) and self.memory.model is None and self.model is not None:
    ...
    def run(
        ...
        *,
        ...
        knowledge_filters: dict[str, Any] | None = None,
        **kwargs: Any,
    ) -> TeamRunResponse | Iterator[TeamRunResponseEvent]:
        ...
        self._set_default_model()
        response_format: dict | type[BaseModel] | None = self._get_response_format()
    ...
    async def arun(
        ...
        *,
        ...
        knowledge_filters: dict[str, Any] | None = None,
        **kwargs: Any,
    ) -> TeamRunResponse | AsyncIterator[TeamRunResponseEvent]:
    ...
    def _handle_model_response_chunk(
        ...
        # If the model response is a tool_call_completed, update the existing tool call in the run_response
            ...
            if stream_intermediate_steps and reasoning_step is not None:
    ...
    def _initialize_session_state(self, user_id: str | None = None, session_id: str | None = None) -> None:
    ...
    def _make_memories_and_summaries(
        self, run_messages: RunMessages, session_id: str, user_id: str | None = None
    ) -> Iterator[TeamRunResponseEvent]:
    ...
    def _get_response_format(self) -> dict | type[BaseModel] | None:
        self.model = cast(Model, self.model)
    ...
    def print_response(
        self,
        message: list | dict | str | Message | None = None,
        *,
        stream: bool = False,
        stream_intermediate_steps: bool = False,
        session_id: str | None = None,
        ...
        tags_to_include_in_markdown: set[str] | None = None,
        audio: Sequence[Audio] | None = None,
        images: Sequence[Image] | None = None,
        videos: Sequence[Video] | None = None,
        files: Sequence[File] | None = None,
            ...
            if isinstance(run_response, TeamRunResponse):
                ...
                if self.show_members_responses:
                    for member_response in run_response.member_responses:
                        ...
                        member_response_content: str | JSON | Markdown = self._parse_response_content(
                            member_response,
                ...
                response_content_batch: str | JSON | Markdown = self._parse_response_content(
        ...
        **kwargs: Any,
        ...
        with Live(console=console) as live_console:
            ...
            for resp in stream_resp:
                ...
                response_content_stream: str | Markdown = _response_content
    ...
    def _get_member_name(self, entity_id: str) -> str:
        for member in self.members:
            ...
            elif isinstance(member, Team) and member.team_id == entity_id:
                return member.name or entity_id
        return entity_id

    def _parse_response_content(
        self,
        run_response: TeamRunResponse | RunResponse,
    ...
    def _calculate_full_team_session_metrics(self, messages: list[Message]) -> SessionMetrics:
        ...
        for member in self.members:
            ...
            if member.memory is not None and isinstance(member.memory, AgentMemory):
    ...
    def _get_reasoning_agent(self, reasoning_model: Model) -> Agent | None:
        return Agent(
    ...
    def _reason(
        ...
        reasoning_model: Model | None = self.reasoning_model
        ...
        if reasoning_model_provided:
            ...
            if is_deepseek or is_groq or is_openai or is_ollama or is_ai_foundry:
                reasoning_message: Message | None = None
                if is_deepseek:
        ...
        if use_default_reasoning:
            ...
            reasoning_agent: Agent | None = self.reasoning_agent  # type: ignore
    ...
    def _create_run_response(
        ...
        audio: list[AudioArtifact] | None = None,
        images: list[ImageArtifact] | None = None,
        videos: list[VideoArtifact] | None = None,
        response_audio: AudioResponse | None = None,
        citations: Citations | None = None,
        model: str | None = None,
        messages: list[Message] | None = None,
        created_at: int | None = None,
        from_run_response: TeamRunResponse | None = None,
    ) -> TeamRunResponse:
        extra_data = None
    ...
    def determine_tools_for_model(
        ...
        knowledge_filters: dict[str, Any] | None = None,
        message: str | list | dict | Message | None = None,
        images: Sequence[Image] | None = None,
        videos: Sequence[Video] | None = None,
        audio: Sequence[Audio] | None = None,
        files: Sequence[File] | None = None,
        ...
        # Prepare tools
        _tools: list[Toolkit | Callable | Function | dict] = []
    ...
    def _format_message_with_state_variables(self, message: Any, user_id: str | None = None) -> Any:
        ...
        for var_name in format_variables:
    ...
    def _update_team_media(self, run_response: TeamRunResponse | RunResponse) -> None:
    ...
    def get_update_user_memory_function(self, user_id: str | None = None, async_mode: bool = False) -> Callable:
    ...
    def get_team_history_function(self, session_id: str) -> Callable:
        def get_team_history(num_chats: int | None = None) -> str:
            """
    ...
    def get_set_shared_context_function(self, session_id: str) -> Callable:
        def set_shared_context(state: str | dict) -> str:
            """
    ...
    def _update_team_session_state(self, member_agent: Agent | Team) -> None:
    ...
    def get_run_member_agents_function(
        ...
        def run_member_agents(task_description: str, expected_output: str | None = None) -> Iterator[str]:
            """
        ...
        async def arun_member_agents(task_description: str, expected_output: str | None = None) -> AsyncIterator[str]:
            """
            Send the same task to all the member agents and return the responses.
    ...
    def get_transfer_task_function(
        ...
        def transfer_task_to_member(
            member_id: str, task_description: str, expected_output: str | None = None
        ) -> Iterator[str]:
    ...
    def _get_member_id(self, member: Agent | Team) -> str:
        """
    ...
    def _find_member_by_id(self, member_id: str) -> tuple[int, Agent | Team] | None:
        """
    ...
    def get_forward_task_function(
        ...
        def forward_task_to_member(member_id: str, expected_output: str | None = None) -> Iterator[str]:
        ...
        async def aforward_task_to_member(member_id: str, expected_output: str | None = None) -> AsyncIterator[str]:
    ...
    def read_from_storage(self, session_id: str) -> TeamSession | None:
    ...
    def write_to_storage(self, session_id: str, user_id: str | None = None) -> TeamSession | None:
    ...
    def rename_session(self, session_name: str, session_id: str | None = None) -> None:
    ...
    def load_team_session(self, session: TeamSession):
        ...
        if not (isinstance(self.memory, (TeamMemory, Memory))):
    ...
    def load_session(self, force: bool = False) -> str | None:
    ...
    def get_messages_for_session(self, session_id: str | None = None, user_id: str | None = None) -> list[Message]:
    ...
    def get_session_summary(self, session_id: str | None = None, user_id: str | None = None):
    ...
    def get_user_memories(self, user_id: str | None = None):
    ...
    def get_relevant_docs_from_knowledge(
        self, query: str, num_documents: int | None = None, filters: dict[str, Any] | None = None, **kwargs
    ...
    def _convert_documents_to_string(self, docs: list[dict[str, Any] | str]) -> str:
    ...
    def _get_team_effective_filters(self, knowledge_filters: dict[str, Any] | None = None) -> dict[str, Any] | None:
        """
    ...
    def search_knowledge_base_function(
        self, knowledge_filters: dict[str, Any] | None = None, async_mode: bool = False
    ) -> Callable:
    ...
    def search_knowledge_base_with_agentic_filters_function(
        ...
        def search_knowledge_base(query: str, filters: dict[str, Any] | None = None) -> str:
            """Use this function to search the knowledge base for information about a query.
        ...
        async def asearch_knowledge_base(query: str, filters: dict[str, Any] | None = None) -> str:
            """Use this function to search the knowledge base for information about a query asynchronously.
    ...
    def _get_team_session(self, session_id: str, user_id: str | None = None) -> TeamSession:
    ...
    def _log_team_run(self, session_id: str, user_id: str | None = None) -> None:
    ...
    async def _alog_team_run(self, session_id: str, user_id: str | None = None) -> None:
        if not self.telemetry and not self.monitoring:
            return
    ...
    def _log_team_session(self, session_id: str, user_id: str | None = None):
    ...
    def _get_agentic_or_user_search_filters(
        self, filters: dict[str, Any] | None, effective_filters: dict[str, Any] | None
    ) -> dict[str, Any]:
