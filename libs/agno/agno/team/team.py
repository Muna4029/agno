...
class Team:
    ...
    #     ...
    retriever: Callable[..., list[dict] | None] | None = None
    ...
    def run(
        ...
        *,
        ...
        knowledge_filters: dict[str, Any] | None = None,
        **kwargs: Any,
    ) -> TeamRunResponse | Iterator[TeamRunResponse]:
    ...
    async def arun(
        ...
        *,
        ...
        knowledge_filters: dict[str, Any] | None = None,
        **kwargs: Any,
    ) -> TeamRunResponse | AsyncIterator[TeamRunResponse]:
        ...
        for attempt in range(num_attempts):
            ...
            # Prepare tools
            _tools: list[Function | Callable | Toolkit | dict] = []
    ...
    def determine_tools_for_model(self, model: Model, tools: list[Function | Callable | Toolkit | dict]) -> None:
    ...
    def _format_message_with_state_variables(self, message: str, user_id: str | None = None) -> Any:
    ...
    def _get_team_effective_filters(
        self, knowledge_filters: dict[str, Any] | None = None, member_filters: dict[str, Any] | None = None
    ) -> dict[str, Any] | None:
        """
